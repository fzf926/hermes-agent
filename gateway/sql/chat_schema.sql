...
CREATE TABLE IF NOT EXISTS chat_sql_execution (
  ...
  total_row_count INT UNSIGNED DEFAULT NULL,
  delivery_mode VARCHAR(32) DEFAULT NULL,
  download_url VARCHAR(2048) DEFAULT NULL,
  generation_reason TEXT DEFAULT NULL,
  export_uid VARCHAR(64) DEFAULT NULL,
  dbops_export_task_id VARCHAR(64) DEFAULT NULL,
  user_display MEDIUMTEXT DEFAULT NULL,
  result_table MEDIUMTEXT DEFAULT NULL,
  created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  KEY idx_chat_sql_export_uid (export_uid),
  PRIMARY KEY (id),
